 ...
 const Emails= [
  ...
  return (
    <div className="privatemessage">
        {Emails.map((Email)=>(
          <div key={Email}>
            <div className="privatemessage_header">
              <div className="privatemessage_avatarsender"> <Avatar /></div>
       
        <span className="privatemessage_pseudosender">{Email.username}</span> 
        ...
        <Markdown />
        <button type="submit" className="privatemessage_buttonsend">Send</button>
      </div>
  );
};
